...
TEST(TSet, equivalence_operator_set_true)
{
  const int size = 5;
  TSet set1(size), set2(size);
...
TEST(TSet, equivalence_operator_set_false)
{
  const int size = 5;
  TSet set1(size), set2(size);
...
TEST(TSet, anti_equivalence_operator_set_true)
{
  const int size = 5;
  TSet set1(size), set2(size);
...
TEST(TSet, anti_equivalence_operator_set_false)
{
  const int size = 5;
  TSet set1(size), set2(size);
